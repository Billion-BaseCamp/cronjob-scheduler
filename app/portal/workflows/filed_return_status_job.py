"""Shared Playwright shell: login → View Filed Returns → read AY status → logout.

Used by CHECK_ITR_VERIFICATION (optional promote) and CHECK_ITR_STATUS_AY (read-only).
"""
...
async def run_filed_return_status_job(
    db,
    job,
    *,
    workflow: str,
    promote_e_verified: bool,
) -> None:
